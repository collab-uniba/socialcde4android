...
public class RecordService_Operation implements Operation {
	...
	public Bundle execute(Context context, Request request)
		...
		String usernameTFS =  request.getString(Consts.TFSUSERNAME);
		String passwordTFS =  request.getString(Consts.TFSPASSWORD);
		String domainTFS =  (request.getString(Consts.TFSDOMAIN) == null) ? "" : request.getString(Consts.TFSDOMAIN);
		...
		try {
			...
			writer.write("{ \"username\":\"" + username + "\", \"password\":\""
					...
					+ "\", \"usernameOnService\":\"" + usernameTFS
					+ "\", \"passwordOnService\": \"" + passwordTFS
					+ "\", \"domain\":\"" + domainTFS + "\"}");
			Log.i("record service request" ,url.toString()+"  \"username\":\"" + username + "\", \"password\":\""
					+ password + "\" , \"service\":\"" + service
					+ "\", \"usernameOnService\":\"" + usernameTFS
					+ "\", \"passwordOnService\": \"" + passwordTFS
					+ "\", \"domain\":\"" + domainTFS + "\"");
			...
			throw new ConnectionException("Error ",Error_consts.RECORD_ERROR * Error_consts.TIMEOUT_FACTOR);
		}  catch (Exception e) {
			throw new ConnectionException("Error ",Error_consts.RECORD_ERROR);
		}
